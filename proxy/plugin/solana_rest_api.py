        ...
        if trx.value and trx.callData:
            ...
            try:
                ...
                if (not trx.toAddress):
                    (signature, contract_eth) = deploy_contract(self.signer,  self.client, trx, self.storage, steps=4000)
                    #self.contract_address[eth_signature] = contract_eth
                else:
                    signature = call_signed(self.signer, self.client, trx, self.storage, steps=4000)
